const algorithmInfos = {
	bubble_sort: {
		name: "Bubble Sort",
		time_complexity: {
			best: ['O(n)', 'bg-[#d4af37] text-[#d4af37]'], // gold
			average: ['O(n²)', 'bg-[#c94f4f] text-[#c94f4f]'], // soft red
			worst: ['O(n²)', 'bg-[#c94f4f] text-[#c94f4f]']
		},
		space_complexity: ['O(1)', 'bg-[#3aa76d] text-[#3aa76d]'], // green
		description: `
			...
			Although bubble sort has a time complexity of O(n²), which makes it less efficient than other sorting algorithms, it can be useful for small arrays or as a simple illustration of how sorting algorithms work.
		`
	},
	insertion_sort: {
		name: "Insertion Sort",
		time_complexity: {
			best: ['O(n)', 'bg-[#d4af37] text-[#d4af37]'],
			average: ['O(n²)', 'bg-[#c94f4f] text-[#c94f4f]'],
			worst: ['O(n²)', 'bg-[#c94f4f] text-[#c94f4f]']
		},
		space_complexity: ['O(1)', 'bg-[#3aa76d] text-[#3aa76d]'],
		description: `
			...
			Insertion sort is a stable sorting algorithm, meaning it preserves the relative order of equal elements in the input array. It is also an in-place algorithm, meaning it requires no additional memory space beyond the original array. However, insertion sort has a time complexity of O(n²) in the worst case, where n is the number of elements in the array. Therefore, it is not recommended for large data sets, but it can be efficient for small or nearly sorted arrays.
		`
	},
	selection_sort: {
		name: "Selection Sort",
		time_complexity: {
			best: ['O(n²)', 'bg-[#c94f4f] text-[#c94f4f]'],
			average: ['O(n²)', 'bg-[#c94f4f] text-[#c94f4f]'],
			worst: ['O(n²)', 'bg-[#c94f4f] text-[#c94f4f]'],
		},
		space_complexity: ['O(1)', 'bg-[#3aa76d] text-[#3aa76d]'],
		description: `
			...
			Although selection sort has a time complexity of O(n²), it can be useful for small arrays or teaching as it is relatively simple.
		`
	},
	merge_sort: {
		name: "Merge Sort",
		time_complexity: {
			best: ['O(n log n)', 'bg-[#3a8dff] text-[#3a8dff]'], // blue
			average: ['O(n log n)', 'bg-[#3a8dff] text-[#3a8dff]'],
			worst: ['O(n log n)', 'bg-[#3a8dff] text-[#3a8dff]'],
		},
		space_complexity: ["O(n)", "bg-[#d4af37] text-[#d4af37]"], // gold
		description: `
	...
	quick_sort: {
		name: "Quick Sort",
		time_complexity: {
			best: ['O(n log n)', 'bg-[#3a8dff] text-[#3a8dff]'],
			average: ['O(n log n)', 'bg-[#3a8dff] text-[#3a8dff]'],
			worst: ['O(n²)', 'bg-[#c94f4f] text-[#c94f4f]']
		},
		space_complexity: ['O(log n)', 'bg-[#3a8dff] text-[#3a8dff]'],
		description: `
	...
	radix_sort: {
		name: "Radix Sort",
		time_complexity: {
			best: ['O(nk)', 'bg-[#d4af37] text-[#d4af37]'], // n*k is linear with coefficient k, essentially O(n). Color Gold.
			average: ['O(nk)', 'bg-[#d4af37] text-[#d4af37]'],
			worst: ['O(nk)', 'bg-[#d4af37] text-[#d4af37]']
		},
		space_complexity: ['O(n+k)', 'bg-[#d4af37] text-[#d4af37]'],
		description: `
